...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		// 2. Give your frame a title
		   frame.setTitle("Nadal");
		// 3. Create a JPanel variable to hold the header using the createHeader method
		JPanel Djokovic = createHeader("Federer");
		// 4. Add the header component to the quizPanel
		quizPanel.add(Djokovic);
	...
	private JButton createButton(String dollarAmount) {
		...
		JButton DelPotro = new JButton(dollarAmount);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		// If the buttonPressed was the firstButton
		  if(buttonPressed == firstButton){
			  askQuestion("In what year did Novak Djokovic win his first French open?", "2016" , 200);
		  }
		...
		// Or if the buttonPressed was the secondButton
		  if(buttonPressed == secondButton){
			  askQuestion("Who won 4 grand slams in a row?", "Novak Djokovic" , 400);
		  }
		  if(buttonPressed == thirdButton){
			  askQuestion("In what year did Nadal first lose at the French Open?", "2009" , 600);
		  }
		  if(buttonPressed == fourthButton){
			  askQuestion("In what year did Nadal win his first French Open?", "2005" , 800);
		  }
