...
public class SimonSaysRecipe extends KeyAdapter {
 ...
 // 2. add 4 images which match keyboard keys like this: images.put(new Integer(KeyEvent.VK_UP), "image.jpg");
 		images.put(new Integer(KeyEvent.VK_UP), "backspace.jpg");
 		images.put(new Integer(KeyEvent.VK_UP), "capslock.jpg");
 		images.put(new Integer(KeyEvent.VK_UP), "enter.jpg");
 		images.put(new Integer(KeyEvent.VK_UP), "shift.jpg");
 ...
 showImage();
	...
	a.setVisible(true);
  	 a.add(getNextRandomImage()); //7. rename to the name of your frame
    	
    	// 8. set the size of the frame 
     	a.setSize(800, 800);
    	// 9. add a key listener to the frame
	a.addKeyListener(null);
